...
public class ProxyServlet extends HttpServlet {
  ...
  /* MISC */
    ...
    protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
        ...
        String oldProxyRequestUri = rewriteUrlFromRequest(servletRequest);
        HttpRequest proxyRequest;
//        if(servletRequest.getRequestURI().equals("/installed")) {
        String    proxyRequestUri2="http://localhost:3000"+servletRequest.getRequestURI();
//        }
        //spec: RFC 2616, sec 4.3: either of these two headers signal that there is a message body.

//        String proxyRequestUri = "http://localhost:3000"+servletRequest.getRequestURI() + oldProxyRequestUri.substring("http://localhost:3000".length()+1);
//        String proxyRequestUri = "http://localhost:3000"+servletRequest.getRequestURI() + oldProxyRequestUri.substring("http://localhost:3000".length()+1);
//        String proxyRequestUri = "http://localhost:3000"+servletRequest.getRequestURI() + oldProxyRequestUri.substring("http://localhost:3000".length()+1);
//        String proxyRequestUri = oldProxyRequestUri.substring("http://");
        String proxyRequestUri = oldProxyRequestUri;
