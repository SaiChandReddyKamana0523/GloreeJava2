...
public class CreateWordTemplateAction extends HttpServlet {
    
	public CreateWordTemplateAction() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		WordTemplate wordTemplate = new WordTemplate(tDCSDocumentId, project.getProjectId(), folderId, templateName,
			templateVisibility, templateDescription, templateFilePath, user.getEmailId(),user.getEmailId(), databaseType);
