				...
				<td>
					<div >			
						<table >
							<tr>
								<td align='left'>
								<div id='createAnAccountForm' class='level1Box'>
									<div class='alert alert-success'>
										<span class='normalText'>
										Congratulations. Your Password has been reset. We have sent an email
										to the address provided with instructions on how to access your system.
										</span>
										<br><br><br><br><br>
									<br><br><br><br><br>
									<br><br><br><br><br>
