...
\
	...
	<div >
		...
		<input type='hidden' name='type' value='requirementsManagement'>
					...
					<div>
						...
						<div id="cNPW" class="level1Box" >	
											...
											<table class='paddedTable' width='100%'>
														...
														<table class='paddedTable'>
																...
																<tr>
																	...
																	<td align='left'>
																		...
																		A 3 letter code that can be used to identify projects
																		</span>
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td align='left'>
																		<span class='normalText'>
																		<input type="text" name="projectOwner" size="30" maxlength="100" 
																		value= '<%=projectOwner%>'>
																		</input>
																		</span>
																	</td>
																...
																<tr>
																	...
																	<td align='left'>
																		<span class='normalText'>
																		<input type="text" name="projectWebsite" size="30" maxlength="1000" 
																...
																<tr>
																	...
																	<td align='left'>
																		<span class='normalText'>
																		<input type="text" name="projectOrganization" size="30" maxlength="100" 
																...
																<tr>
																	...
																	<td align='left'>
																		<span class='normalText'>
																		<input type="text" name="projectTags" size="30" maxlength="1000" 
																		value= '<%=projectTags%>'>
																		</input>
																		</span>
																	</td>
												...
												<tr>
													<td align='left'>
													<input type="hidden" name="restrictedDomains" size="50" maxlength="100" 
													...
													<!-- 
														...
														<table class='paddedTable'>
															...
															<tr>
																...
																<td align='left'>
																	<span class='normalText'>
																	<input type="text" name="restrictedDomains" size="50" maxlength="100" 
																	value='<%=restrictedDomains%>'>
																	</input>
																	</span>
																</td>
															...
															<tr>
																<td align='left'>
																	<span class='headingText'>
																	Administrators (comma separated email Ids)</span>
																</td>
																<td align='left'>
																	<span class='normalText'>
																	<input type="text" name="administrators" size="50" maxlength="100" 
															...
															<tr>
																<td align='left'>
																	<span class='headingText'>
																	Users (comma separated email Ids)</span>
																</td>
																<td align='left'>
																	<span class='normalText'>
																	<input type="text" name="users" size="50" maxlength="100" 
																	value='<%=users%>'>
																	</input>
																	</span>
																</td>
