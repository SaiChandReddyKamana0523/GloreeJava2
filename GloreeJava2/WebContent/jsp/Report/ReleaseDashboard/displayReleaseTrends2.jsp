...
<%if (dRIsMember){ 
	...
	System.out.println("srt in sbux : numOfIncompleteRequirementsString is " + incompleteRequirementsDataString);
...
%>
   ...
   <head>
      ...
      <script src="/GloreeJava2/js/oPExplorer.js?v=20190950"></script>
	...
	<br><br>
      ...
      <script language = "JavaScript">
         function drawChart() {
            ...
            var incompleteData = google.visualization.arrayToDataTable(<%=incompleteRequirementsDataString%>);
            var incompleteOptions = {title: 'Incomplete Requirements', isStacked:true, width:1000, height:400 };  
            var incompleteChart = new google.visualization.ColumnChart(document.getElementById('incompleteRequirements'));
            incompleteChart.draw(incompleteData, incompleteOptions);
