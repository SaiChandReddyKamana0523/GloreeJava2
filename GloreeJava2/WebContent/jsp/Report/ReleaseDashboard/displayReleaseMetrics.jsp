...
<%if (dRIsMember){ 
	...
	ArrayList reqTypes = ReleaseMetricsUtil.getRequirementTypesForReleaseOrProject(releaseId,project.getProjectId());
	
	String allRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfRequirements", databaseType);
	String draftRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfDraftRequirements", databaseType);
	String inApprovalWorkflowRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfInApprovalWorkflowRequirements", databaseType);
	String rejectedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfRejectedRequirements", databaseType);
	String approvedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfApprovedRequirements", databaseType);
	String danglingRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfDanglingRequirements", databaseType);
	String orphanRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfOrphanRequirements", databaseType);
	String suspectUpstreamRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfSuspectUpstreamRequirements", databaseType);
	String suspectDownstreamRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfSuspectDownstreamRequirements", databaseType);
	String completedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfCompletedRequirements", databaseType);
	String incompleteRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfIncompleteRequirements", databaseType);
	
	String testPendingRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfTestPendingRequirements", databaseType);
	String testPassRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfTestPassRequirements", databaseType);
	String testFailRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForReleaseOrProject(releaseId,project.getProjectId(), "numOfTestFailRequirements", databaseType);
	
	
	
	String defectRequirementsDataString = ReleaseMetricsUtil.getDefectTrendDataString("release",releaseId, databaseType);
	ArrayList defectStatusGroupsForProject = ReleaseMetricsUtil.getDefectStatusGroupsInMetrics("release", releaseId);	
...
<body id="yahoo-com" class=" yui-skin-sam">
	...
	<div class='level1Box' style="text-align:left">		
		<span class="chart_title">Release Trends
				
								
			<a href='/GloreeJava2/servlet/ReportAction?action=exportReleaseTrendData&releaseId=<%=releaseId%>'
						target='_blank'  title='Excel file of Release Trends Data'>
		...
		//--- data
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'All',
					content: '<span class="chart_title">All Requirements in Release</span><div class="chart" id="allRequirementsChart"></div>',
					active: true
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Draft',
					content: '<span class="chart_title">Draft Requirements in Release</span><div class="chart" id="draftRequirementsChart"></div>'
			}));
		
			//Add a tab for the in approval work flow Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Pending',
					content: '<span class="chart_title">In Approval Workflow Requirements in Release</span><div class="chart" id="inApprovalWorkflowRequirementsChart"></div>'
			}));
		
			//Add a tab for the rejected reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Rejected',
					content: '<span class="chart_title">Rejected Requirements in Release</span><div class="chart" id="rejectedRequirementsChart"></div>'
			}));
		
			//Add a tab for the approved reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Approved',
					content: '<span class="chart_title">Approved Requirements in Release</span><div class="chart" id="approvedRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Dangling',
					content: '<span class="chart_title">Dangling (without a child) Requirements in Release</span><div class="chart" id="danglingRequirementsChart"></div>'
			}));
		
			//Add a tab for the orphan reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Orphan',
					content: '<span class="chart_title">Orphan (without a parent) Requirements in Release</span><div class="chart" id="orphanRequirementsChart"></div>'
			}));
			//Add a tab for the suspectUpstream reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Suspect Upstream',
					content: '<span class="chart_title">Requirements with a suspect trace upstream in Release</span><div class="chart" id="suspectUpstreamRequirementsChart"></div>'
			}));
		
			//Add a tab for the suspectDownstream reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Suspect Downstream',
					content: '<span class="chart_title">Requirements with a suspect trace downstream in Release</span><div class="chart" id="suspectDownstreamRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
				label: 'Defects',
				content: '<span class="chart_title">Defects in this Release</span><div class="chart" id="defectRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Completed',
					content: '<span class="chart_title">Completed Requirements in Release</span><div class="chart" id="completedRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Incomplete',
					content: '<span class="chart_title">Incomplete Requirements in Release</span><div class="chart" id="incompleteRequirementsChart"></div>'
			}));
