...
if (dRIsMember){ 
	...
	ArrayList reqTypes = ReleaseMetricsUtil.getRequirementTypesForAgileSprint(sprintId,project.getProjectId());
	
	String allRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfRequirements", databaseType);
	String draftRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfDraftRequirements", databaseType);
	String inApprovalWorkflowRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfInApprovalWorkflowRequirements", databaseType);
	String rejectedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfRejectedRequirements", databaseType);
	String approvedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfApprovedRequirements", databaseType);
	String danglingRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfDanglingRequirements", databaseType);
	String orphanRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfOrphanRequirements", databaseType);
	String suspectUpstreamRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfSuspectUpstreamRequirements", databaseType);
	String suspectDownstreamRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfSuspectDownstreamRequirements", databaseType);
	String completedRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfCompletedRequirements", databaseType);
	String incompleteRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfIncompleteRequirements", databaseType);
	
	String testPendingRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfTestPendingRequirements", databaseType);
	String testPassRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfTestPassRequirements", databaseType);
	String testFailRequirementsDataString = ReleaseMetricsUtil.getTrendDataStringForAgileSprint(sprintId,project.getProjectId(), "numOfTestFailRequirements", databaseType);
...
<body id="yahoo-com" class=" yui-skin-sam">
	...
	<div class='level1Box' style="text-align:left">		
		...
		<span class="chart_title">Project Trends</span>
