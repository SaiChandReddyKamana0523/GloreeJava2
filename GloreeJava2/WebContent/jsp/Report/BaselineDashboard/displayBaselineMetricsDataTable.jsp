...
<%if (IsMember){ %>
	...
	String lastDataLoadDt =  ReleaseMetricsUtil.getLastDataLoadDtForBaseline(rTBaselineId,project.getProjectId(), databaseType);

	// lets get the list of distinct req types in this release tree.	
	ArrayList dataTable = ReleaseMetricsUtil.getReleaseDataTableArrayForBaseline(
			rTBaselineId,project.getProjectId(), user, databaseType);
		...
		<tr>
			<td bgcolor="#99ccff" align="left">				
				<span class="subSectionHeadingText">
					...
					as of '<%=lastDataLoadDt%>' for '<%=rTBaseline.getBaselineName()%>'
					<%} %>
				</span>
			</td>		
		</tr>
						    		...
						    		<tr>
						    			<td colspan='7'>
						    				<div class='alert alert-success'>
						    					<span class='normalText'> No Requirements were found for this Baseline.
						    					<br><br>Please Note that the Baseline Metrics get calculated once a night and 
						    					the Metrics calculation script may not have had a chance to run since
						    					you have added Requirements to this Baseline.
						    					</span>
						    				</div>
						    			</td>
						    		</tr>
					...
					<%
					 ...
					 %>
				 				<tr>
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "all")' >
							 			 <%=numOfRequirements%></a>
							 			</span>
							 		</td>
									...
									<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "draft")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "pending")' >
									...
									<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "rejected")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "approved")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "dangling")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "orphan")' >
									...
									<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "suspectUpstream")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "suspectDownstream")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "pendingTesting")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "passedTesting")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "failedTesting")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "completed")' >
							 		...
							 		<td class='<%=cellStyle%>'>
							 			<span class='normalText'>
							 			<a href='#' onclick='displayBaselineRequirements(<%=rTBaselineId%>,"<%=requirementTypeShortName%>", "incomplete")' >
