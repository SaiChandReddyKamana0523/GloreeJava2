...
<%if (dRIsMember){ 
	...
	String defectRequirementsDataString = ReleaseMetricsUtil.getDefectTrendDataString("project",project.getProjectId(), databaseType);
	ArrayList defectStatusGroupsForProject = ReleaseMetricsUtil.getDefectStatusGroupsInMetrics("project", project.getProjectId());	
...
<body id="yahoo-com" class=" yui-skin-sam">
	...
	<div class='level1Box' style="text-align:left">		
		...
		<span class="chart_title">Project Trends   
		...
		//--- data
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'All',
					content: '<span class="chart_title">All Requirements in Project</span><div class="chart" id="allRequirementsChart"></div>',
					active: true
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Draft',
					content: '<span class="chart_title">Draft Requirements in Project</span><div class="chart" id="draftRequirementsChart"></div>'
			}));
		
			//Add a tab for the in approval work flow Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Pending',
					content: '<span class="chart_title">In Approval Workflow Requirements in Project</span><div class="chart" id="inApprovalWorkflowRequirementsChart"></div>'
			}));
		
			//Add a tab for the rejected reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Rejected',
					content: '<span class="chart_title">Draft Requirements in Project</span><div class="chart" id="rejectedRequirementsChart"></div>'
			}));
		
			//Add a tab for the approved reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Approved',
					content: '<span class="chart_title">Draft Requirements in Project</span><div class="chart" id="approvedRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Dangling',
					content: '<span class="chart_title">Dangling (without a child) Requirements in Project</span><div class="chart" id="danglingRequirementsChart"></div>'
			}));
		
			//Add a tab for the orphan reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Orphan',
					content: '<span class="chart_title">Orphan (without a parent) Requirements in Project</span><div class="chart" id="orphanRequirementsChart"></div>'
			}));
			//Add a tab for the suspectUpstream reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Suspect Upstream',
					content: '<span class="chart_title">Requirements with a suspect trace upstream in Project</span><div class="chart" id="suspectUpstreamRequirementsChart"></div>'
			}));
		
			//Add a tab for the suspectDownstream reqs Chart
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Suspect Downstream',
					content: '<span class="chart_title">Requirements with a suspect trace downstream in Project</span><div class="chart" id="suspectDownstreamRequirementsChart"></div>'
			}));


			tabView.addTab( new YAHOO.widget.Tab({
				label: 'Defects',
				content: '<span class="chart_title">Defects in Project</span><div class="chart" id="defectRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Completed',
					content: '<span class="chart_title">Completed Requirements in Project</span><div class="chart" id="completedRequirementsChart"></div>'
			}));
			...
			tabView.addTab( new YAHOO.widget.Tab({
					label: 'Incomplete',
					content: '<span class="chart_title">Incomplete Requirements in Project</span><div class="chart" id="incompleteRequirementsChart"></div>'
			}));
	...
	<input type='button' class='btn btn-xs btn-prime' value='All' onClick='displayProjectTrend2()'>
	<div id='projectTrend2Div' style='display:none'></div>
</body>
