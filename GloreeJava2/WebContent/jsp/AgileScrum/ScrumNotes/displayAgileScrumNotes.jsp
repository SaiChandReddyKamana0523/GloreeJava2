					...
					<div>
						...
						<table class='paddedTable' width='100%'>
							...
							<tr>
								...
								<td colspan='2' >
									<span class='normalText'>
										<textarea rows='10' cols='120' id='scrumNotes' name='scrumNotes'></textarea>	
									</span>
								</td>
							</tr>	
							...
							<tr>
								<td colspan='2' align='left'>
									<span class='normalText'>
									<input type='button' class='btn btn-primary btn-sm' name='createSprintLogButton'  id='createSprintLogButton' value='Add Notes' onClick='this.disabled="true"; addScrumNotes(<%=sprint.getSprintId() %>)'>
									</span>
								</td>
							</tr>	
							...
							<tr>
								<td colspan='2' align='center'>
									<div id='scrumNotesHistoryDiv' style='display:none'></div>
								</td>
							</tr>								
						</table>
