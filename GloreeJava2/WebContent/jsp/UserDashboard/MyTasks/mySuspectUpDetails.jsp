...
try {	
	...
	ArrayList mySuspectUpRequirements = ProjectUtil.getSuspectUpRequriements(securityProfile, user.getEmailId(), databaseType, targetProjectId , dashboardType, ownedBy);
%>
	...
	<tr>
		<td colspan='7' align='center'>
			<%if (ownedBy.equals(user.getEmailId())) { %>
				<span class='normalText'><b>My items that have a suspect trace upstream</b></span>
			<%}
			else {
			%>
				<span class='normalText'><b><%=ownedBy %>'s items that have a suspect trace upstream</b></span>
			<%
			}%>
