...
try {	
	...
	int mySuspectUpStreamRequirements = ProjectUtil.getSuspectUpStreamRequriementsCount(user.getEmailId(), targetProjectId,  dashboardType, ownedBy);
	if (mySuspectUpStreamRequirements == 0 ){
%>
	<span style="color:gray; font-size:15pt"><b><%=mySuspectUpStreamRequirements %></b>  </span><span class='normalText' style='color:gray'>  <br></br>Suspect Upstream</span>
<%
	}
	else {
%>
	<a href='#' onclick='mySuspectUpDetails(<%=targetProjectId%>,"<%=dashboardType%>","<%=ownedBy%>")'><span style="color:red; font-size:15pt"><b><%=mySuspectUpStreamRequirements %></b></SPAN><br></br>Suspect Upstream</a>
