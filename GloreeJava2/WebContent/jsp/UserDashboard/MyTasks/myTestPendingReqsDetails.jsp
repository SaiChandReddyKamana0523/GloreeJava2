...
try {	
	...
	ArrayList myTestPendingRequirements = ProjectUtil.getTestPendingRequriements(securityProfile, user.getEmailId(), databaseType, targetProjectId, dashboardType, ownedBy);
%>
	...
	<tr>
		<td colspan='7' align='center'>
			<%if (ownedBy.equals(user.getEmailId())) { %>
				<span class='normalText'><b>My Items that are pending testing</b></span>
			<%}
			else {
			%>
				<span class='normalText'><b><%=ownedBy %>'s Items that are pending testing</b></span>
			<%
			}%>
