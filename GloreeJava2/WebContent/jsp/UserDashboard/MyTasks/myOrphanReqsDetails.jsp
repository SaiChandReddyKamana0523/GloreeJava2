...
try {	
	...
	ArrayList myOrphanRequirements = ProjectUtil.getOrphanRequriements(securityProfile, user.getEmailId(), databaseType, targetProjectId, dashboardType, ownedBy);
%>
...
<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			...
			%>
				<span class='normalText'><b><%=ownedBy%>'s Orphan (Do not have a upstream trace) Items</b></span>
			<%
			}%>		
