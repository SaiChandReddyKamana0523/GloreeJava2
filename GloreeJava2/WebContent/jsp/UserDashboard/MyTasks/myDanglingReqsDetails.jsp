...
try {	
	...
	ArrayList myDanglingRequirements = ProjectUtil.getDanglingRequriements(securityProfile, user.getEmailId(), databaseType, targetProjectId , dashboardType, ownedBy);
%>
...
<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			...
			%>
				<span class='normalText'><b><%=ownedBy%>'s Dangling (Do not have a downstream trace) Items</b></span>
			<%
			}%>
		</td>
	</tr>
