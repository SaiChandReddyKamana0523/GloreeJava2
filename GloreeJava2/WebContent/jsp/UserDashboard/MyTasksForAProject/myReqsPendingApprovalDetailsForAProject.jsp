...
try {	
	...
	ArrayList mRequirementsPendingApproval = ProjectUtil.getRequirementsThatArePendingApproval(securityProfile, user.getEmailId(), databaseType, project.getProjectId() , dashboardType, ownedBy);
%>
