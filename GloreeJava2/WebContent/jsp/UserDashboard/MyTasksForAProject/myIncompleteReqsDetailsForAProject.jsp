...
try {	
	...
	ArrayList myIncompleteRequirements = ProjectUtil.getIncompleteRequriements(securityProfile, user.getEmailId(), databaseType, project.getProjectId(),  dashboardType, ownedBy );
%>
