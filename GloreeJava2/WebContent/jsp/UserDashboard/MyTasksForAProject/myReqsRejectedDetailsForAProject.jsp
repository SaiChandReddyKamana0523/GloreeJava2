...
try {	
	...
	ArrayList mRequirementsRejected = ProjectUtil.getRequirementsThatAreRejected(securityProfile, user.getEmailId(), databaseType, project.getProjectId(), dashboardType, ownedBy);
%>
