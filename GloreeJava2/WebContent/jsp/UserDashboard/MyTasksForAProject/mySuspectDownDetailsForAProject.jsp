...
try {	
	...
	ArrayList mySuspectDownRequirements = ProjectUtil.getSuspectDownRequriements(securityProfile, user.getEmailId(), databaseType, project.getProjectId(), dashboardType, ownedBy);
%>

<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			<span class='normalText'><b>Items that have a suspect trace downstream </b></span>
		</td>
	</tr>
	<tr>
