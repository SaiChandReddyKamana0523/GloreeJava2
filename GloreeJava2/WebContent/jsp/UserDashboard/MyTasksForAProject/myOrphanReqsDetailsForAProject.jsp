...
try {
	...
	ArrayList myOrphanRequirements = ProjectUtil.getOrphanRequriements(securityProfile, user.getEmailId(), databaseType, project.getProjectId(), dashboardType, ownedBy);
%>

<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			<span class='normalText'><b>My Orphan (Do not have a upstream trace) Items</b></span>
		</td>
	</tr>
	<tr>
		<td colspan='7' align='right'>
			<a href='#' onclick='displayMyTasksForAProject();'>
			<img src="/GloreeJava2/images/return.jpg" width="16" border="0" > Return to My Tasks </a>
		</td>
	</tr>
<%
	...
	Iterator oR = myOrphanRequirements.iterator();
	
	while (oR.hasNext()){
		Requirement r = (Requirement) oR.next();
