...
try {	
	...
	ArrayList myDanglingRequirements = ProjectUtil.getDanglingRequriements(securityProfile, user.getEmailId(), databaseType, project.getProjectId(), dashboardType, ownedBy);
%>

<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			<span class='normalText'><b>My Dangling (Do not have a downstream trace) Items</b></span>
		</td>
	</tr>
	<tr>
		<td colspan='7' align='right'>
			<input type='button' class='btn btn-danger btn-sm'  onclick='displayMyTasksForAProject();' value='  Return to My Tasks  '></intput>
		</td>
	</tr>
<%
	...
	Iterator dR = myDanglingRequirements.iterator();
