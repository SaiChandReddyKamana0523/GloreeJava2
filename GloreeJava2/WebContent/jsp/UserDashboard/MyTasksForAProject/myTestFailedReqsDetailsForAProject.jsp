...
try {	
	...
	ArrayList myTestFailedRequirements = ProjectUtil.getTestFailedRequriements(securityProfile, user.getEmailId(), databaseType, project.getProjectId(), dashboardType, ownedBy);
%>

<table class='paddedTable'  width='100%'>
	<tr>
		<td colspan='7' align='center'>
			<span class='normalText'><b>Items that have failed testing</b></span>
		</td>
	</tr>
	<tr>
