	...
	<table class='paddedTable'>
			...
			<td class='tableHeader' width='200'>
				<div>
					...
					<div style='float:right'>
						<div id='expandAllUpdatableAttributesDiv' style='display:none'>
							<a href='#' onClick='expandAllUpdatableAttributes();'> &nbsp;(Expand)&nbsp; </a>
						</div>
						<div id='collapseAllUpdatableAttributesDiv' style='display:block'>
							<a href='#' onClick='collapseAllUpdatableAttributes();'> &nbsp;(Collapse)&nbsp; </a>
						</div>
		...
		%>
			<tr>
				...
				<td class='<%=tdClass %>'>				
						<input type='text'  name='votingRights<%=rolePriv.getFolderId()%>'
						id='votingRights<%=rolePriv.getFolderId()%>'  value='<%=rolePriv.getVotingRights()%>'> 
				...
				<td class='<%=tdClass %>'>	
					<div>	
						...
						<div id='updateAttributesDiv<%=rolePriv.getFolderId()%>' style='display:block'>
		...
		<%}%>
			...
			<td colspan='7' align="left">
				<span class='normalText'>
					...
					<input type="button" class="btn btn-sm btn-primary" name="Submit Changes" 
