...
<% }
	...
	String powerUserSettings = project.getPowerUserSettings();
		if (
			(dRFSecurityProfile.getRoles().contains("AdministratorInProject" + project.getProjectId())
			||
			(
			(dRFSecurityProfile.getRoles().contains("PowerUserInProject" + project.getProjectId()))
				&&
...
<% if (dRFIsAdmin){ %>
	...
	<table class='paddedTable' width='100%'>
		...
		<% if (users.size() > 0){ %> 
			...
			<tr>
			<td colspan="2" align='left'>
			<div id='deleteAllUsersInRoleMessage' class='alert alert-success'>
